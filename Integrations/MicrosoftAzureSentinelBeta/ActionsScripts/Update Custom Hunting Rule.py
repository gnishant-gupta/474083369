...
def main():
    ...
    display_name = extract_action_param(
        siemplify, param_name="Display Name", print_value=True
    )
    ...
    hunting_rule_id = extract_action_param(
        siemplify, param_name="Hunting Rule ID", is_mandatory=True, print_value=True
    )
