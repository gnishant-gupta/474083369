...
class AlertRuleProperties(BaseModel):
    ...
    def parse_iso8601_time(time):
        ...
        return f'{days} {"day" if days == 1 else "days"} {hours} {"hour" if hours == 1 else "hours"} {minutes} {"minute" if minutes == 1 else "minutes"} {seconds} {"second" if seconds == 1 else "seconds"}'
